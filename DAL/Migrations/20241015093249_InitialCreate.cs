    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TripsTripID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VehiclesVehicleID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripVehicle", x => new { x.TripsTripID, x.VehiclesVehicleID });
                    table.ForeignKey(
                        name: "FK_TripVehicle_Trips_TripsTripID",
